 ...
 * @return 	None
 */
void AudioDMA(uint16_t * DACBuffer, uint32_t DACBufferSize, uint32_t DMA_Mode){
 ...
 * @return 	None
 */
void AudioInit(uint16_t *DACBuffer, uint32_t DACBufferSize, uint32_t DMA_Mode, uint16_t wavPeriod, uint16_t preScaler){
